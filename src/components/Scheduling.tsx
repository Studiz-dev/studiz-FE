...
export default function Scheduling({ title }: SchedulingProps) {
    ...
    return (
        <button onClick={() => navigate("/SchedulePage")} className="flex items-center px-5 w-full h-[85px] bg-white rounded-[15px] border-[1.5px] border-main1 justify-between px-4">
